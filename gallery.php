...
<html lang="en" class="no-js">
	<head>
		...
		<title>CombatPestochem | Gallery</title>
		<meta name="author" content="Made By: 3XGARBAGELAB">
	...
	<body>
		...
		<div class="container">
			<header class="clearfix">
				<!--<span><span class="bp-icon bp-icon-about" "></span></span>-->	
                
                <!--<img src="images/logo/cp_logo.png"  />-->
                <a href="index.php"><img src="img/home.png" width="92px;" height="92px;" style="position:relative"></a>  
			...
			<div id="grid-gallery" class="grid-gallery">
				<section class="grid-wrap">
					<ul class="grid">
						...
						<li>
							<figure>
								<img src="GridGallery/img/thumb/1.png" alt="img01"/>
								<figcaption><h3>Combat Pestochem</h3><p>Sample text</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="GridGallery/img/thumb/2.png" alt="img02"/>
								<figcaption><h3>Combat Pestochem</h3><p>Sample text </p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="GridGallery/img/thumb/3.png" alt="img03"/>
								<figcaption><h3>Combat Pestochem</h3><p>Sample text </p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="GridGallery/img/thumb/4.png" alt="img04"/>
								<figcaption><h3>Combat Pestochem</h3><p>Sample text </p></figcaption>
							</figure>
						</li>
						<!--<li>
				...
				<section class="slideshow">
					<ul>
						<li>
							<figure>
								<figcaption>
									<h3>Combat Pestochem</h3>
									<p>Sample Text</p>
								</figcaption>
								<img src="GridGallery/img/large/1.png" alt="img01"/>
							</figure>
						</li>
						<li>
							<figure>
								<figcaption>
									<h3>Combate Pestochem</h3>
									<p>Sample Text</p>
								</figcaption>
								<img src="GridGallery/img/large/2.png" alt="img02"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="GridGallery/img/large/3.png" alt="img03"/>
							</figure>
						</li>
						<li>
							<figure>
								...
								<img src="GridGallery/img/large/4.png" alt="img04"/>
							</figure>
						</li>
						<!--<li>
							<figure>
